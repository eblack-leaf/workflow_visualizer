...
impl Color {
    ...
    pub const DARK_ORANGE: (f32, f32, f32) = (0.25, 0.10, 0.00);
    pub const DARK_CYAN: (f32, f32, f32) = (0.0, 0.06, 0.03);
    ...
    pub const RED_ORANGE: (f32, f32, f32) = (0.4, 0.01, 0.001);
    ...
    pub const BLUE_DARK: (f32, f32, f32) = (0.0, 0.01, 0.02);
