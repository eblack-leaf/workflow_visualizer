...
fn generate_panel_mesh() {
    ...
    {
        let corner_center = Position::<DeviceView>::new(1.0 - radius, radius);
        ...
        let mut last = corner_center
            + Position::<DeviceView>::from((current.cos() * radius, -current.sin() * radius));
        current += interval;
        while current < end {
        ...
        let bar_top = Position::<DeviceView>::from((bar_bottom.x, bar_bottom.y - radius));
    ...
    {
        let corner_center = Position::<DeviceView>::from((radius, radius));
        corners.push(corner_center);
        ...
        let bar_bottom = corner_center;
        let bar_top = Position::<DeviceView>::from((bar_bottom.x - radius, bar_bottom.y));
    ...
    {
        let corner_center = Position::<DeviceView>::from((radius, 1.0 - radius));
        corners.push(corner_center);
        let mut current = PI;
        let total = FRAC_PI_2;
    ...
    {
        let corner_center = Position::<DeviceView>::from((1.0 - radius, 1.0 - radius));
        corners.push(corner_center);
