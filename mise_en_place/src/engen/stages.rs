use bevy_ecs::prelude::{apply_system_buffers, IntoSystemConfig, IntoSystemSetConfig, IntoSystemSetConfigs, SystemSet};
...
pub(crate) fn staged_backend() -> Job {
    ...
    job.startup.add_system(apply_system_buffers.in_set(BackEndStartupBuckets::StartupClear));
    job.main.configure_sets((
        BackendBuckets::Initialize.after(JobBucket::Idle).before(BackendBuckets::GfxSurfaceResize),
