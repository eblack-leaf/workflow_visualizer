...
use crate::{
    Color, Extract, Job, Layer, RawArea, RawPosition, Render, RenderPassHandle, RenderPhase,
    Viewport,
};
...
impl IconRenderer {
    ...
    pub(crate) fn add_icon(&mut self, entity: Entity, icon: IconAdd) {
        ...
        self.position
            ...
            .write
            .write
            .insert(index, icon.panel.section.position.as_raw());
        self.area
            .get_mut(&icon.key)
            .unwrap()
            .write
    ...
    pub(crate) fn process_differences(
        ...
        for (entity, pos) in differences.position.iter() {
            ...
            self.position
                ...
                .write
                .write
                .insert(index, pos.to_device(scale_factor).as_raw());
        }
                ...
                let pipeline_descriptor = wgpu::RenderPipelineDescriptor {
                    ...
                    vertex: VertexState {
                        ...
                        buffers: &[
                            ...
                            wgpu::VertexBufferLayout {
                                array_stride: std::mem::size_of::<RawPosition>()
                                    as wgpu::BufferAddress,
